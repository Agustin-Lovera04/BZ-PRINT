    ...
    return (
        <>
            <div className="quienesSomos-Container">
                <h1 className='d-flex flex-row aling-items-right gap-3 col-12 m-2'><span className="TitleQuienesSomos-Content fw-bold ">¿QUIENES </span> <span className="TitleQuienesSomos2-Content fw-bold"> SOMOS?</span></h1>
