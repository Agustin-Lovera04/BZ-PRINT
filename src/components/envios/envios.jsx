        ...
        <>
            <div className="envios-Container">
                ...
                <div className="envios-Content col-12">
                    <div className="pEnvios col-12 col-lg-6" data-aos="fade-right" data-aos-duration="1500">
                    ...
                    <div className="imgEnvios-Container col-12 col-lg-6" data-aos="fade-left" data-aos-duration="1500">
